...
const DATA = [
  ...
  },
  {
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeWKG5dAZB8-lDbpJ81gNaWfMgrRLXXSDMVQ&s',
...
const styles = StyleSheet.create({
  ...
  selectedFilter: { backgroundColor: "#A5B68D" },
  ...
  card: {
    ...
    borderRadius: 8,
    borderWidth: 1, // Menambahkan bingkai
    borderColor: "#ddd", // Warna bingkai
    shadowColor: "#000",
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.1,
    shadowRadius: 4,
    elevation: 3, // Memberikan efek elevasi (shadow di Android)
  },
  cardContent: { flex: 1, marginLeft: 10 },
  cardTitle: { fontSize: 16, fontWeight: "bold", color: "#333" },
  cardOverview: { fontSize: 14, color: "#666", marginTop: 4 },
  recipeImage: { width: 80, height: 80, borderRadius: 8 },
  modalOverlay: {
    flex: 1,
  ...
  modalDescription: { fontSize: 16, color: "#333" },
  closeButton: {
    position: "absolute",
    top: 10,
    right: 10,
  ...
  closeButtonText: { fontSize: 14, color: "#333" },
});
